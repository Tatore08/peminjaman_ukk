...
<div class="space-y-6">
    ...
    <div class="flex items-center space-x-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Tambah kategori alat baru</p>
        </div>
    </div>
        ...
        <form action="{{ route('kategori.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="3"
                    ...
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm resize-none">{{ old('deskripsi') }}</textarea>
            </div>
